...
TrafficLightItem::TrafficLightItem(QPointF pos, Qt::Orientation orientation, bool pedestrian)
...
void TrafficLightItem::paint(QPainter *painter, const QStyleOptionGraphicsItem *, QWidget *) {
